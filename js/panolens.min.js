(function (h, e) {
  ...
  function ba(a, b) {
    ...
    var f = this, D = new e.Vector2, h = new e.Vector2, r = new e.Vector2, n = new e.Vector2, U = new e.Vector2,
      t = new e.Vector2, u = new e.Vector3, A = new e.Vector3, y = new e.Vector2, z = new e.Vector2, T = new e.Vector2,
      R = 0, H = 0, B = 0, C = 0, E = 1,
    ...
    this.update = function (a) {
      if (!1 !== c.enabled) {
        var b = c.deviceOrientation.alpha ? e.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle : 0,
          ...
          v = new e.Quaternion(-Math.sqrt(.5), 0, 0, Math.sqrt(.5)), h = new e.Quaternion, r = new e.Quaternion;
    ...
    Object.assign(Object.create(e.Sprite.prototype), {
      ...
      updateCanvasArcByProgress: function (a) {
        ...
        var a = this, b = this.context, c = this.canvasWidth, d = this.canvasHeight, g = this.material,
          ...
          e = performance.now(), m = this.color, l = this.dpr, h = .5 * c / l, q = .5 * d / l, f = function () {
            var p = window.requestAnimationFrame(f), v = (performance.now() - e) / k, n = 0 < 1 - v ? 1 - v : 0,
              r = v * c * .5 / l;
            b.clearRect(0, 0, c, d);
            b.beginPath();
  ...
  z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
    ...
    onClick: function (a) {
      ...
      if (this.getContainer()) {
        var b = this.cursorStyle || (this.mode === t.NORMAL ? "pointer" : "default"), c = this.scaleDownAnimation,
          d = this.scaleUpAnimation, g = this.element;
        this.isHovering = !0;
